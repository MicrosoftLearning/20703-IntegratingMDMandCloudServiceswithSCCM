...
7. Click  **OK** to close the **Deploy Terms and Conditions** dialog box. Notice that the Deployed column now shows the word "True," which indicates the policy has been deployed.
