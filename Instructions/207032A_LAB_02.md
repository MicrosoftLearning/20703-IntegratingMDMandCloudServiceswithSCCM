...
2. From the  **Azure Active Directory** page, access the Azure classic portal.

3. From the  **SETTINGS** page, upload the new management certificate from **C:\CMGCertificate.cer**. 
