...
4. On the directory page, under  **MANAGE**, click  **Users**.

5. On the  **Users** page, click **All users**.

6. In the user list, click  **Adam Hobbs**.

7. On the  **Adam Hobbs** page, click **Directory role**.

8. On the  **Directory role** page, click **Add role**, select **Global administrator**, and then click  **Select**.
...
12. In the  **Azure AD Premium P2** box, click **Free trial**.
...
8. Next to  **Office 365 Business**, click the slide button to the  **On** position. Notice that Microsoft Office 365 contains a number of applications in addition to Office 365 Business.
...
6. On the  **Office** page, take note of the **Office 365 Business** apps that can be installed on your computer.
...
## Exercise 3: Modifying Office 365 options for manual downloads
...
6. On the  **Software Updates** page, configure the **Property filters** as follows:
