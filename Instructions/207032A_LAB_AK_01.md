...
3. In the  **Azure Active Directory** pane, click **Classic portal**. Sign in with the Microsoft account that is associated with your Azure trial subscription.

4. Scroll down in the navigation pane, and then click  **SETTINGS**.

5. On the  **Settings** page, click **MANAGEMENT CERTIFICATES**, and then click  **UPLOAD A MANAGEMENT CERTIFICATE**.

6. In the  **Upload a management certificate** box, click **BROWSE FOR FILE**.

7. In the  **Choose File to Upload** dialog box, browse to **\\LON-CFG\C$**, and then select  **Azurecertificate.cer**.

8. Click  **Open**, and then click the check mark to start the upload. In a few moments, the certificate will display on the  **MANAGEMENT CERTIFICATES** page.
