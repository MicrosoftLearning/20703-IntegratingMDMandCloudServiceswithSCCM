...
5. After your Microsoft account is created, close Internet Explorer.
...
26. At the top right-hand corner of the Azure Portal, click the  **Sync user** account, and then click **Sign out**. 
...
2. In the navigation pane, click  **All services**.
