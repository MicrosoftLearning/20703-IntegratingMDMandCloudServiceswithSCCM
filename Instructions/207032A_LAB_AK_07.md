...
6. On the  **Work access** page, under **Sign in to Azure AD**, click **Add or remove a work or school account**.

7. Under  **Accounts used by other apps**, click **Add a work or school account**.

8. On the  **Let's get you signed in** page, enter the following information, and then press Enter (complete the wizard as necessary):

  - Name:  **Abbi@&lt; _domain_&gt;.onmicrosoft.com**

  - Password:  **Pa55w.rd**

9. On the  **Your're all set** page, click **Done**.
10. Click the **Settings** button, and then click **Accounts**.
11. Click **Work access**, and then under **Enroll in to device management**, click **Enroll in to device management**. Provide Abbi's email address and complete the wizard.

12. Under  **Enroll in to device management**, notice that  **Adatum Corporation** is listed.

13. Click  **Adatum Corporation**, and then click the  **Sync** button.

14. To go back to the  **Start** screen, press F2.

15. On the Start screen, click the  **Store** tile.

16. Click the search button, type  **Company Portal**, and then press Enter.

17. In the  **Apps** list, click **Company Portal**, and then click  **Free**.

18. On the  **credentials** page, provide the Microsoft Account credentials that you created in Module 1.
...
19. On the  **Sign in to this device using your Microsoft account** page, click **Just sign in to this app**.

20. After the app is installed, click  **Open**.

21. Verify that the Company Portal app displays the  **Adatum Corporation** home page.
...
5. Under  **Birthday**, enter your birthday by using the  **Month**,  **Day**, and  **Year** fields.
6. Under **Gender**, select your gender.

7. On the  **Privacy and Terms** page, scroll down, and then click **I AGREE**.

8. On the  **Welcome** page, verify that you have options to configure your account.
...
5. Right-click  **Abbi_WindowsPhone**, point to  **Remote Device Actions**, click  **Remote Lock** and then click **Yes**.
